...
Необходимо написать программу, находящую мощность множества точек
пересечения границы выпуклой оболочки со сторонами заданного треугольника.
...
1) Написать метод определения пересечения двух отрезков, а также метод
определяющий, лежит ли заданная точка на заданном отрезке.
2) Для отрезков выпуклой оболочки нужно знать количество точек пересечения с
заданным треугольником, для вершины выпуклой оболочки необходимо знать,
лежит ли она на заданном треугольнике. При удалении ребра из счетчика вычитаем
количество точек пересечения этого ребра с заданным треугольником, при удалении
вершины вычитаем из счетчика 1, если вершина лежит на заданном треугольнике.
Также стоит учесть случай, когда мощность множества точек пересечения равна
бесконечности.
